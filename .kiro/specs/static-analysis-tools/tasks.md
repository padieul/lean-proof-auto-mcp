...
- [ ] Set up test infrastructure (add jsonschema and hypothesis to dependencies, create test directories)
- [ ] Write scan_file contract tests (schema compliance, required fields, determinism, error handling)
