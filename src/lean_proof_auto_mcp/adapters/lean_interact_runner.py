...
class LeanInteractRunner:
    ...
    def __init__(self, server_manager: LeanInteractServerManager, timeout_buffer_ms: int = 100) -> None:
        """
...
class LeanInteractServer:
    ...
    def __init__(self, server_manager: LeanInteractServerManager, workspace_path: Path) -> None:
        """
