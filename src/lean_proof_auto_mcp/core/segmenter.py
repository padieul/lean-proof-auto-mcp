...
def segment_proof(source: SourceText, decl: TheoremDecl) -> ProofStructure:
    ...
    if not decl.proof_span:
        ...
        return ProofStructure(skeleton=[], blocks=[], cases=[])
    ...
    return ProofStructure(skeleton=skeleton, blocks=blocks, cases=cases)
    ...
    for line_idx, line in enumerate(lines):
        ...
        for pattern in case_patterns:
            ...
            if match:
                ...
                # Create case block
                case_span = Span(
                    start_line=proof_start_line + case_start, end_line=proof_start_line + case_end
                )
