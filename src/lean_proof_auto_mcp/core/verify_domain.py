...
class VerifyCommandHandler:
    ...
    def _build_evidence(self, lean_result: LeanRunResult, max_log_excerpt_chars: int) -> dict[str, Any]:
        """
    ...
    def _build_timing(self, total_s: float, lean_execution_s: float, overhead_s: float) -> dict[str, float]:
        """
