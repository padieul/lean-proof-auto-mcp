...
class TestClassifyLine:
    ...
    def test_closing_tactics(self):
        ...
        closing_lines = ["exact h", "rfl", "trivial", "done", "assumption", "linarith"]
    ...
    def test_unknown_lines(self):
        ...
        unknown_lines = ["", "-- comment", "some_custom_tactic", "variable (x : Nat)"]
...
class TestIdentifyBlocks:
    ...
    def test_single_block(self):
        ...
        proof_lines = ["intro h", "cases h with", "apply theorem"]
    ...
    def test_blocks_with_empty_lines(self):
        ...
        proof_lines = ["intro h", "", "cases h with", "", "", "exact rfl"]
